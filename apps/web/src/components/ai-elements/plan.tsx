...
export type PlanTriggerProps = Omit<ComponentProps<typeof CollapsibleTrigger>, "asChild">;

export const PlanTrigger = ({ className, ...props }: PlanTriggerProps) => (
  <CollapsibleTrigger className={cn("size-8", className)} data-slot="plan-trigger" {...props}>

...
export function PromptInputProvider({
  ...
  // Sync ref with latest attachments
  useEffect(() => {
...
// Check browser support outside component to avoid re-checking on every render
...
export const PromptInputSpeechButton = ({
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- Valid pattern for client-side capability check
